  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto p-4">
        <Card>
          <CardHeader>
            <CardTitle className="text-center text-xl">저장소 설정</CardTitle>
                    ...
                    <div className="flex items-center space-x-3 p-4 border rounded-lg hover:bg-muted/30 cursor-pointer">
                      ...
                      <Label htmlFor="google-drive" className="flex-1 cursor-pointer">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-medium">클라우드 저장</p>
                            <p className="text-sm text-muted-foreground">암호화된 데이터가 안전한 클라우드 서버에 저장됩니다.</p>
                          </div>
              ...
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-muted-foreground mt-1">
                    데이터는 암호화되어 저장됩니다. 여러 곳에 저장할수록 보안이 강화됩니다.
                  </p>
                </div>
              </div>
            </div>
