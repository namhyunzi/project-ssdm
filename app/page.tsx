  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
          ...
          {/* Updated bottom text */}
          <div className="border-t border-border p-4 text-center space-y-2">
            {/* <Link href="/support" className="text-sm text-muted-foreground hover:text-primary block">
              로그인에 문제가 있으신가요?
            </Link> */}
            <Link href="/partner-login" className="text-sm text-primary hover:text-primary/80 font-medium">
              파트너사이신가요?
            </Link>
          </div>
        </Card>
