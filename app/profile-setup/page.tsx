...
import { formatPhoneNumber, formatTime, handleAddressSearch } from "@/lib/utils"
              ...
              <Button 
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    const validPhone = fullPhone.length >= 10 ? fullPhone : '' // 10자리 미만이면 빈 문자열로 저장
                    ...
                    sessionStorage.setItem('temp_profile_data', JSON.stringify(profileData))
                    console.log('개인정보 임시 저장 완료, 분산저장소 설정으로 이동')
